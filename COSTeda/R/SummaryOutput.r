...
#il faut commencer par insérer la donnée temporelle dans les tables
...
#on colle l'année au champ trimestre, semestre et mois
...
#la dernière ligne est spécifique : analyse des classes de tailles (proportion de classes de taille dans CS présentes dans CA
