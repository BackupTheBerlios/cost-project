...
Delta(object,species,tempStrata=NULL,spaceStrata=NULL,techStrata=NULL,
      elmts=list(tp="all",sp="all",tc="all"),indSamp=FALSE,strategy="metier",\dots)
}
...
\arguments{
  ...
  \item{elmts}{List of components of stratification. Default value is \code{"all"}. See Details.}
