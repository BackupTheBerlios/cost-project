...
return(list(dbeTotcatch.land=fillTabFromRep(dbeTotcatch.land),dbeTotcatch.disc=fillTabFromRep(dbeTotcatch.disc),dbeMean.lga.land=fillTabFromRep(dbeMean.lga.land),
            dbeMean.wga.land=fillTabFromRep(dbeMean.wga.land),dbeMean.lga.disc=fillTabFromRep(dbeMean.lga.disc),dbeMean.wga.disc=fillTabFromRep(dbeMean.wga.disc)))
}
