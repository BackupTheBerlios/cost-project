...
________________________________________________________________
        ...
        $Id: caa_lqp.c,v 1.1 2009/06/04 12:49:10 davidhirst Exp $
	Copyright 2003, 
________________________________________________________________
*/
...
{
  int  err;
  double Ages,mu,mean,tau,x,opt_x;
...
Date:
Source file: $Id: caa_lqp.c,v 1.1 2009/06/04 12:49:10 davidhirst Exp $
________________________________________________________________
*/
...
{
  int     i;
  double  eps,delta,f_opt,f_l,f_m,f_u,x_l,x_m,x_u;
