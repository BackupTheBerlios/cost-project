...
obj <- WL.plot(sole3.cs,selection=TRUE)
obj
...
pushViewport(viewport(layout.pos.col=1,layout.pos.row=1)) ; print(WL.plot(sole3.cs),newpage=FALSE) ; popViewport(1)
pushViewport(viewport(layout.pos.col=2, layout.pos.row=1)) ; print(ML.plot(sole3.cs),newpage=FALSE) ; popViewport(1)
pushViewport(viewport(layout.pos.col=1, layout.pos.row=2)) ; print(ML.boxplot(sole3.cs),newpage=FALSE) ; popViewport(1)
pushViewport(viewport(layout.pos.col=2, layout.pos.row=2)) ; print(SL.boxplot(sole3.cs),newpage=FALSE) ; popViewport(1)
